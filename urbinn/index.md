...
Inmiddels is het week 4 en is einde van sprint 2 in zicht. De mile van sprint 2 is voor het grote deel behaald. Wij zijn in staat om de KITTI testdataset in te laden in het ORB-SLAM2 algoritme en een pointcloud te kunnen creëren. Het is ons ook gelukt om de pointcloud op te slaan en opnieuw in te laden. Op dit moment zijn wij bezig om de afstanden in kaart te brengen tussen de keyframes en de orbs. Hierdoor zijn wij in staat diepte aangegeven van objecten in een bepaald frame. 
